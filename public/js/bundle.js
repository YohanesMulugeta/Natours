...
exports.showAlert = exports.removeAlert = void 0;
/* eslint-disable */
var removeAlert = function removeAlert() {
  var _document$querySelect;
  (_document$querySelect = document.querySelector('.alert')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.remove();
};
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.post('http://127.0.0.1:8000/api/v1/users/login', {
            email: email,
            password: password
          });
        case 3:
          ...
          if (data.status === 'success') {
            ...
            (0, _alert.showAlert)('success', 'You are successfully loged in.');
            setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _axios.default.get('http://127.0.0.1:8000/api/v1/users/logout');
        case 3:
          res = _context2.sent;
          (0, _alert.showAlert)('success', 'Success fully loged out');
          setTimeout(function () {
        ...
        case 8:
          ...
          (0, _alert.showAlert)('error', 'Error on logout.');
        case 11:
        case "end":
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieW9oYW5lczIxIiwiYSI6ImNsZTYyemh1djBmbWszdnM0ZHdwYm02czYifQ._NwU-4qyQ2dl9DVZq0GvvQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/yohanes21/cle72qxev004601q9fdmbazeo/draft',
    // style URL
    scrollZoom: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map)).setLngLat(loc.coordinates).addTo(map);
    marker.togglePopup();
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _context.abrupt("return", console.error('the second argument to updataSettings function has to be either password or data'));
        case 3:
          urlExtension = type === 'password' ? 'MyPassword' : 'Me';
          _context.next = 6;
          return (0, _axios.default)({
            method: 'patch',
            url: "http://127.0.0.1:8000/api/v1/users/update".concat(urlExtension),
            data: data
          });
        case 6:
          response = _context.sent;
          if (response.data.status === 'success') (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " Update successful"));
          setTimeout(function () {
            location.reload(true);
          }, 1500);
          _context.next = 15;
        ...
        case 11:
          ...
          (0, _alert.showAlert)('error', _context.t0.response ? _context.t0.response.data.message : _context.t0.message);
        case 15:
        case "end":
          return _context.stop();
      }
...
var settingsForm = document.querySelector('.form-user-settings');
...
logoutBtn === null || logoutBtn === void 0 ? void 0 : logoutBtn.addEventListener('click', _login.logout);
dataForm === null || dataForm === void 0 ? void 0 : dataForm.addEventListener('submit', function (e) {
  e.preventDefault();
...
settingsForm === null || settingsForm === void 0 ? void 0 : settingsForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var password, newPassword, passwordConfirm, btn;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          ...
          btn = document.querySelector('.btn--password-update');
          console.log(btn);
          if (!(newPassword !== passwordConfirm)) {
            _context.next = 8;
            break;
          }
          return _context.abrupt("return", showAlert('error', 'New password and password confirm has to be the same'));
        case 8:
